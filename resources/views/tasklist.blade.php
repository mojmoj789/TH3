                ...
                <div class="card px-3">
                    <div class="card-body">
                        ...
                        <div class="add-items d-flex">
                            <input type="text" class="form-control todo-list-input" placeholder="Nhập việc cần làm">
                            <button class="add btn btn-primary font-weight-bold todo-list-add-btn">Thêm</button>
                        </div>
...
{{--                                    </label>--}}
{{--                                </div>--}}
{{--                                <i class='remove fa fa-times'></i> </li>`);//Sử dụng class fa fa-times của font awesome.--}}
{{--                    todoListInput.val("");--}}
{{--                }--}}
{{--            });--}}
